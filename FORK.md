...
| 2026-05-22 | *(pending)* | **Batch clips:** multiple start/end rows for one URL; **Download each clip** or **Download merged** (ffmpeg concat); API `POST /add-batch`; UI table under Advanced Options. |
