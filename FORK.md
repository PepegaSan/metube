...
| 2026-05-22 | [`554f402`](https://github.com/PepegaSan/metube/commit/554f402) | **Extension deep link:** `?url=…&clips=…` prefills URL, single-clip fields, or batch table; companion repo `metube-extension`. |
...
**Batch clips (this commit):** `app/ytdl.py`, `app/main.py`, `app/tests/test_batch_clips.py`, `ui/src/app/app.ts`, `ui/src/app/app.html`, `ui/src/app/services/downloads.service.ts`, `FORK.md`
